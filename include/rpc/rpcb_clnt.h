...
__BEGIN_DECLS
LIBRPC_API bool_t rpcb_set(const rpcprog_t, const rpcvers_t,
			const struct netconfig  *, const struct netbuf *);
LIBRPC_API bool_t rpcb_unset(const rpcprog_t, const rpcvers_t,
			 const struct netconfig *);
LIBRPC_API rpcblist	*rpcb_getmaps(const struct netconfig *, const char *);
#ifndef __LIBC12_SOURCE__
LIBRPC_API enum clnt_stat rpcb_rmtcall(const struct netconfig *,
...
#endif
LIBRPC_API bool_t rpcb_getaddr(const rpcprog_t, const rpcvers_t,
			   const struct netconfig *, struct netbuf *,
			   const  char *);
#ifndef __LIBC12_SOURCE__
LIBRPC_API bool_t rpcb_gettime(const char *, time_t *) __RENAME(__rpcb_gettime50);
#endif
LIBRPC_API char *rpcb_taddr2uaddr(struct netconfig *, struct netbuf *);
LIBRPC_API struct netbuf *rpcb_uaddr2taddr(struct netconfig *, char *);
__END_DECLS
