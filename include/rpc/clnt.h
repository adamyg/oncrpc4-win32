 ...
 */
__BEGIN_DECLS
LIBRPC_API CLIENT *clnt_create(const char *, const rpcprog_t, const rpcvers_t, const char *);
/*
 *
 ...
 */
LIBRPC_API CLIENT *clnt_create_vers(const char *, const rpcprog_t, rpcvers_t *,
 ...
 * instead of nettype
 */
LIBRPC_API CLIENT *clnt_tp_create(const char *, const rpcprog_t,
...
LIBRPC_API CLIENT *clnt_tli_create(/*const*/ int, const struct netconfig *,
 ...
 */
LIBRPC_API CLIENT *clnt_vc_create(const int, const struct netbuf *,
 ...
 */
LIBRPC_API CLIENT *clnt_dg_create(const int, const struct netbuf *,
				   const rpcprog_t, const rpcvers_t,
				   /*const*/ unsigned int, /*const*/ unsigned int);
/*
 *	const int fd;				-- open file descriptor
 ...
 *	unsigned long vers;
 */
LIBRPC_API CLIENT *clnt_raw_create	(rpcprog_t, rpcvers_t);
 ...
 */
__BEGIN_DECLS
LIBRPC_API void clnt_pcreateerror	(const char *);		/* stderr */
LIBRPC_API char *clnt_spcreateerror	(const char *);		/* string */
__END_DECLS
 ...
 */ 
__BEGIN_DECLS
LIBRPC_API void clnt_perrno		(enum clnt_stat);		/* stderr */
LIBRPC_API char *clnt_sperrno	(enum clnt_stat);		/* string */
__END_DECLS
 ...
 */
__BEGIN_DECLS
LIBRPC_API void clnt_perror		(CLIENT *, const char *); 	/* stderr */
LIBRPC_API char *clnt_sperror	(CLIENT *, const char *);	/* string */
__END_DECLS
...
__BEGIN_DECLS
LIBRPC_API struct rpc_createerr	*__rpc_createerr(void);
__END_DECLS
 ...
 */
__BEGIN_DECLS
LIBRPC_API enum clnt_stat rpc_call(const char *, const rpcprog_t,
...
__BEGIN_DECLS
LIBRPC_API enum clnt_stat rpc_broadcast(const rpcprog_t, const rpcvers_t,
    const rpcproc_t, const xdrproc_t, const char *, const xdrproc_t, caddr_t,
    const resultproc_t, const char *);
LIBRPC_API enum clnt_stat rpc_broadcast_exp(const rpcprog_t, const rpcvers_t,
    const rpcproc_t, const xdrproc_t, const char *, const xdrproc_t, caddr_t,
