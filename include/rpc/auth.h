...
__BEGIN_DECLS
LIBRPC_API bool_t xdr_des_block(XDR *, des_block *);
__END_DECLS
...
__BEGIN_DECLS
struct sockaddr_in;
LIBRPC_API AUTH *authunix_create		(char *, int, int, int, int *);
LIBRPC_API AUTH *authunix_create_default	(void);
LIBRPC_API AUTH *authnone_create		(void);
LIBRPC_API AUTH *authdes_create			(char *, unsigned int, struct sockaddr_in *, des_block *);
LIBRPC_API bool_t xdr_opaque_auth		(XDR *, struct opaque_auth *);

#if defined(_WIN32)
LIBRPC_API const struct opaque_auth *_svcauth_null_auth(void);
#endif
