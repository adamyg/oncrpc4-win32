 ...
 * 	struct rpc_msg *cmsg;
 */
LIBRPC_API bool_t	xdr_callmsg	(XDR *, struct rpc_msg *);
 ...
 * 	struct rpc_msg *cmsg;
 */
LIBRPC_API bool_t	xdr_callhdr	(XDR *, struct rpc_msg *);
 ...
 * 	struct rpc_msg *rmsg;
 */
LIBRPC_API bool_t	xdr_replymsg	(XDR *, struct rpc_msg *);
 ...
 */
LIBRPC_API bool_t	xdr_accepted_reply	(XDR *, struct accepted_reply *);
 ...
 */
LIBRPC_API bool_t	xdr_rejected_reply	(XDR *, struct rejected_reply *);
 ...
 */
LIBRPC_API void	_seterr_reply	(struct rpc_msg *, struct rpc_err *);
__END_DECLS
