...
__BEGIN_DECLS
LIBRPC_API void *__rpc_setconf(const char *);
LIBRPC_API void __rpc_endconf(void *);
LIBRPC_API struct netconfig *__rpc_getconf(void *);
LIBRPC_API struct netconfig *__rpc_getconfip(const char *);
__END_DECLS
