...
void *nfsproc3_null_3(void *, CLIENT *);
void *nfsproc3_null_3_svc(void *, struct svc_req *);
GETATTR3res *nfsproc3_getattr_3(GETATTR3args *, CLIENT *);
GETATTR3res *nfsproc3_getattr_3_svc(GETATTR3args *, struct svc_req *);
SETATTR3res *nfsproc3_setattr_3(SETATTR3args *, CLIENT *);
SETATTR3res *nfsproc3_setattr_3_svc(SETATTR3args *, struct svc_req *);
LOOKUP3res *nfsproc3_lookup_3(LOOKUP3args *, CLIENT *);
LOOKUP3res *nfsproc3_lookup_3_svc(LOOKUP3args *, struct svc_req *);
ACCESS3res *nfsproc3_access_3(ACCESS3args *, CLIENT *);
ACCESS3res *nfsproc3_access_3_svc(ACCESS3args *, struct svc_req *);
READLINK3res *nfsproc3_readlink_3(READLINK3args *, CLIENT *);
READLINK3res *nfsproc3_readlink_3_svc(READLINK3args *, struct svc_req *);
READ3res *nfsproc3_read_3(READ3args *, CLIENT *);
READ3res *nfsproc3_read_3_svc(READ3args *, struct svc_req *);
WRITE3res *nfsproc3_write_3(WRITE3args *, CLIENT *);
WRITE3res *nfsproc3_write_3_svc(WRITE3args *, struct svc_req *);
CREATE3res *nfsproc3_create_3(CREATE3args *, CLIENT *);
CREATE3res *nfsproc3_create_3_svc(CREATE3args *, struct svc_req *);
MKDIR3res *nfsproc3_mkdir_3(MKDIR3args *, CLIENT *);
MKDIR3res *nfsproc3_mkdir_3_svc(MKDIR3args *, struct svc_req *);
SYMLINK3res *nfsproc3_symlink_3(SYMLINK3args *, CLIENT *);
SYMLINK3res *nfsproc3_symlink_3_svc(SYMLINK3args *, struct svc_req *);
MKNOD3res *nfsproc3_mknod_3(MKNOD3args *, CLIENT *);
MKNOD3res *nfsproc3_mknod_3_svc(MKNOD3args *, struct svc_req *);
REMOVE3res *nfsproc3_remove_3(REMOVE3args *, CLIENT *);
REMOVE3res *nfsproc3_remove_3_svc(REMOVE3args *, struct svc_req *);
RMDIR3res *nfsproc3_rmdir_3(RMDIR3args *, CLIENT *);
RMDIR3res *nfsproc3_rmdir_3_svc(RMDIR3args *, struct svc_req *);
RENAME3res *nfsproc3_rename_3(RENAME3args *, CLIENT *);
RENAME3res *nfsproc3_rename_3_svc(RENAME3args *, struct svc_req *);
LINK3res *nfsproc3_link_3(LINK3args *, CLIENT *);
LINK3res *nfsproc3_link_3_svc(LINK3args *, struct svc_req *);
READDIR3res *nfsproc3_readdir_3(READDIR3args *, CLIENT *);
READDIR3res *nfsproc3_readdir_3_svc(READDIR3args *, struct svc_req *);
READDIRPLUS3res *nfsproc3_readdirplus_3(READDIRPLUS3args *, CLIENT *);
READDIRPLUS3res *nfsproc3_readdirplus_3_svc(READDIRPLUS3args *, struct svc_req *);
FSSTAT3res *nfsproc3_fsstat_3(FSSTAT3args *, CLIENT *);
FSSTAT3res *nfsproc3_fsstat_3_svc(FSSTAT3args *, struct svc_req *);
FSINFO3res *nfsproc3_fsinfo_3(FSINFO3args *, CLIENT *);
FSINFO3res *nfsproc3_fsinfo_3_svc(FSINFO3args *, struct svc_req *);
PATHCONF3res *nfsproc3_pathconf_3(PATHCONF3args *, CLIENT *);
PATHCONF3res *nfsproc3_pathconf_3_svc(PATHCONF3args *, struct svc_req *);
COMMIT3res *nfsproc3_commit_3(COMMIT3args *, CLIENT *);
COMMIT3res *nfsproc3_commit_3_svc(COMMIT3args *, struct svc_req *);
#ifdef __cplusplus
};
#endif
