...
extern "C" {
#endif
LIBRPC_API bool_t xdr_netbuf(XDR *, struct netbuf *);
#ifdef __cplusplus
};
#endif
...
extern "C" {
#endif
LIBRPC_API bool_t xdr_rpcb(XDR *, rpcb *);
LIBRPC_API bool_t xdr_rp__list(XDR *, rp__list *);
LIBRPC_API bool_t xdr_rpcblist_ptr(XDR *, rpcblist_ptr *);
LIBRPC_API bool_t xdr_rpcb_rmtcallargs(XDR *, rpcb_rmtcallargs *);
LIBRPC_API bool_t xdr_rpcb_rmtcallres(XDR *, rpcb_rmtcallres *);
LIBRPC_API bool_t xdr_rpcb_entry(XDR *, rpcb_entry *);
LIBRPC_API bool_t xdr_rpcb_entry_list(XDR *, rpcb_entry_list *);
LIBRPC_API bool_t xdr_rpcb_entry_list_ptr(XDR *, rpcb_entry_list_ptr *);
LIBRPC_API bool_t xdr_rpcbs_addrlist(XDR *, rpcbs_addrlist *);
LIBRPC_API bool_t xdr_rpcbs_rmtcalllist(XDR *, rpcbs_rmtcalllist *);
LIBRPC_API bool_t xdr_rpcbs_proc(XDR *, rpcbs_proc);
LIBRPC_API bool_t xdr_rpcbs_addrlist_ptr(XDR *, rpcbs_addrlist_ptr *);
LIBRPC_API bool_t xdr_rpcbs_rmtcalllist_ptr(XDR *, rpcbs_rmtcalllist_ptr *);
LIBRPC_API bool_t xdr_rpcb_stat(XDR *, rpcb_stat *);
LIBRPC_API bool_t xdr_rpcb_stat_byvers(XDR *, rpcb_stat_byvers);
#ifdef __cplusplus
};
#endif
