/* File created from rpcbind_usage.txt via mklicense.pl */
const char *rpcbind_usage[] = {
	"",
	"",
	"NAME",
	"",
	...
	"",
	"     -l      Turns on libwrap connection logging [not supported].",
	"",
	...
	"",
	"     -W      Enable libwrap (TCP wrappers) support [not supported].",
	"",
	"     -w      Enable the warmstart feature [not supported].",
	"",
